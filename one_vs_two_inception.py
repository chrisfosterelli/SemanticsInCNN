...
for i in range(20):
	...
	shuffle(correct_class_correlation_matrix)
	correct_class_correlation_matrix_copy=correct_class_correlation_matrix
	wrong_class_correlation_matrix_copy=wrong_class_correlation_matrix

	for i in range(len(incorrect)):
		total+=1
		correct_class_corr_wv = correct_class_correlation_matrix_copy[i]
		incorrect_class_corr_wv=wrong_class_correlation_matrix_copy[i]
		cnn_act_corr= cnn_correlation_matrix[i]
		actual_class_correlation=pearsonr(cnn_act_corr[0],correct_class_corr_wv[0])[0]
		wrong_class_correlation=pearsonr(cnn_act_corr[0],incorrect_class_corr_wv[0])[0]			
		if actual_class_correlation > wrong_class_correlation:
