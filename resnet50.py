...
def get_CNN_vector(IMG_PATH,DICTIONARY,layer_name,size_words):
    ...
    #joblib.dump(word_vector,"lastLayer_activations_nopearson.pkl")
    #raise Exception("ResNet50 stop")
...
def getinfo():
    model = ResNet50(include_top=True, weights='imagenet')
    print(model.summary())
    plot_model(model, to_file='model_RESNET50.png',show_shapes=True)


if __name__ == '__main__':
    getinfo()

    img_path ='/Users/Dhanush/Desktop/Projects/BrainBench-CNNVisualizations/deep-learning-models/DataScienceImages/airplane.jpg'
    model = ResNet50(include_top=True, weights='imagenet')
